...
do
	...
	do
		...
		if not isfile(Library.FolderName .. '/Utilities/Hue.png') then
			writefile(Library.FolderName .. '/Utilities/Hue.png', game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/hue.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Saturation.png') then
			writefile(Library.FolderName .. '/Utilities/Saturation.png', game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/saturation.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Value.png') then
			writefile(Library.FolderName .. '/Utilities/Value.png', game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/value.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Shadow.png') then
			writefile(Library.FolderName .. '/Utilities/Shadow.png', game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/shadow.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Logo.png') then
			writefile(Library.FolderName .. '/Utilities/Logo.png', game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/fishy.png"));
		end;
	end;
	...
	local Typeface = loadstring(game:HttpGet("https://raw.githubusercontent.com/x01dev/fishy/main/assets/typeface.lua"))()
	local LibFont = Typeface:Register("Typefaces", {
		name = "smallest pixel",
		weight = "Regular",
		style = "Normal",
		link = "https://raw.githubusercontent.com/xtrtle304/fishy_lib/refs/heads/main/smallest_pixel-7.ttf",
	}) 
